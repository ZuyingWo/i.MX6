...
// Added by Aptina[sukumar@aptina.com]
// added mt9d115 support
#if defined(CONFIG_MXC_CAMERA_OV5640_MIPI) || defined(CONFIG_MXC_CAMERA_OV5640_MIPI_MODULE) || defined(CONFIG_MXC_CAMERA_MT9D115_MIPI)
...
static struct fsl_mxc_camera_platform_data camera_mipi_data = {
	.mclk = 24000000,
	.csi = 0,
...
static struct i2c_board_info mxc_i2c1_board_info[] __initdata = {
...
#if defined(CONFIG_MXC_CAMERA_OV5640_MIPI) || defined(CONFIG_MXC_CAMERA_OV5640_MIPI_MODULE)
	{
		...
		.platform_data = (void *)&camera_mipi_data,
	},
#endif
// Added by Aptina[sukumar@aptina.com]
// I2C address of mt9d115
#if defined(CONFIG_MXC_CAMERA_MT9D115_MIPI)
	{
		I2C_BOARD_INFO("mt9d115_mipi", (0x78 >> 1)),
		.platform_data = (void *)&camera_mipi_data,
	},
#endif
...
static struct mipi_csi2_platform_data mipi_csi2_pdata = {
	...
	.v_channel = 0,
	// Added by Aptina[sukumar@aptina.com]
	// mt9d115 supports one 1 lane MIPI
	.lanes = 1, //2,

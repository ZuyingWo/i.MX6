...
#define V4L2_PIX_FMT_GREY   ipu_fourcc('G','R','E','Y')	/*!< 8 Greyscale */
#define V4L2_PIX_FMT_Y16    ipu_fourcc('Y','1','6',' ') /*!< 16 Greyscale */
        ...
        for (i = 1; i < argc; i++) {
			...
			if (strcmp(argv[i], "NV12") == 0) {
				...
				g_bpp = 12;
                        ...
                        else if (strcmp(argv[i], "Y16") == 0) {
                                g_pixelformat = V4L2_PIX_FMT_Y16;
                                g_bpp = 16;
                        }
                        else if (strcmp(argv[i], "Y8") == 0) {
                                g_pixelformat = V4L2_PIX_FMT_GREY;
                                g_bpp = 8;
                        }
                        else {
